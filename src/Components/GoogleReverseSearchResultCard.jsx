// GoogleReverseSearchResultCard.js
import React from 'react';

const GoogleReverseSearchResultCard = ({ data }) => {
  return (
    <div style={{ border: '1px solid #ccc', borderRadius: '8px', margin: '16px', padding: '16px', width: '300px', overflow: 'hidden' }}>
      <h3>Google Reverse Image Search Results</h3>
...
export default GoogleReverseSearchResultCard;
